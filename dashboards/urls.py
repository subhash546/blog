...
from .views import dashboard,category,categoryadd,categoryEdit,categorydelete,posts,addposts,deletepost,editpost,users,adduser,edituser,deleteuser
...
urlpatterns=[
    ...
    path('/delete/users/<int:pk>/',deleteuser,name="deleteuser")
